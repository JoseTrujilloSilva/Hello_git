...
function codigo() {
    ...
    var idCom = window.location.href.split('?')[1].split(',')[1].split('=')[1];
    ...
    $('#explorar').attr('href', '../explorar/explorar.php?idUser='+idUser);
    ...
    function eventoCarouselAtras() {
        ...
        $('#idTarianComment').val(carousel[contCarousel][0][7]);
